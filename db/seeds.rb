...
shops = Shop.create(brand_name: "flose", description: " hydratés, fortifiés et démêlés en douceur.
La solution Les soins pour cheveux frisés", address: "20 rue de Bellevue Saint Martin",phone: "0690 00 70 40",
...
shops = Shop.create(brand_name: "baume iles", description: "Il lisse la cuticule du cheveu et le protège contre les agressions
extérieures, notamment pour les cheveux chimiquement traités (colorations,",address:"limilord port 97400 lamentin martinique" ,
phone: "0873801009" , banner_url:"https://cdn.aroma-zone.com/cms/sites/default/files/fiche_technique/emulgels/Grande-photo-presentation_Emulgel_confort-musculaire_0.jpg",
...
shops = Shop.create(brand_name: "oils nature", description: "L'huile végétale d'amande douce est obtenue par pression à froid
...
phone: "0590363940", banner_url:"https://images.unsplash.com/profile-1582795063523-f92a89921286image?dpr=1&auto=format&fit=crop&w=150&h=150&q=60&crop=faces&bg=fff",
...
shops = Shop.create(brand_name: "chantilym", description: "Un beurre riche et dense au premier regard. Une crème
ultra-hydratante au fini poudré qui fond sur la peau en l’appliquant",address: "120 boulevard des princes 99400 Guyane",
phone:'0594003058', banner_url:"https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1176&q=80",
...
shops = Shop.create(brand_name: "shampooing luxe", description: "Le besoin Souvent fins et fragiles, les cheveux frisés ou
crépus peuvent être difficiles à démêler, avoir des frisottis et des boucles non-définies.",
address: "rue de la marne 97240 martinique", phone: "0696602040", banner_url:"https://media.slidesgo.com/storage/13091348/responsive-images/reusing-plastic-bottles-workshop1635416625___media_library_original_548_308.jpg",
...
Product = product.create(name:"Huile Végétale BIO de Chanvre", descrition: "'huile végétale de chanvre est connue pour
...
Product = product.create(name:"Baume Réparateur COSMOS", descrition: "Ce baume a été spécialement conçu pour nourrir
...
Product = product.create(name:"MASQUE SOIN PATAUA", descrition: "Force et réparation pour les cheveux fins et fragiles
...
Product = product.create(name:"SHAMPOOING POUR CHEVEUX GRAS", descrition: "Ce shampooing rafraîchissant associe la bétaïne
...
Product = product.create(name:"SHAMPOOING LOW-POO", descrition: "Le besoin Souvent fins et fragiles, les cheveux frisés ou crépus
